        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PricePerNightAdult = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PricePerNightChild = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    RoomType = table.Column<int>(type: "int", nullable: false),
                    BreakfastPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    AllInclusivePrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "admin@example.com", "Admin", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), true, "User", "base", "vYtFshp2QChz3x5PBtVNCTzskb+/7rVDklWzM2n8XhMEUopthiAO0sFsWrLjHbc9", "1234567890", 0, null, "0987654321", "admin" });
